 ...
 * 		creer les cases noires et blanches et les positionner au bon endroit sur le damier
 * 		creer les pions noirs et blancs en leur affectant une image et les positionner sur leur case initiale
...
public class GuiFactory {
	 ...
	 * la case en bas e gauche est noire
	 */
	public static BorderPane createSquare(int col, int ligne) {
		...
		// la couleur est definie par les valeurs par defaut de configuration
	 ...
	 * @param col
	 * @param ligne
	 * @return une PieceGui si col/ligne correspond e cases noires
	 ...
	 * la promotion consiste e changer l'image de la PieceGui
	 */
	 ...
	 * @param pieceColor
	 * @param ispawn
	 * @return une image cree e partir d'un fichier png
	 */
